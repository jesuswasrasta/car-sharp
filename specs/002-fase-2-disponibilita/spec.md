...
**Feature Branch**: `002-fase-2-disponibilita`  
**Created**: 2026-01-13  
**Status**: Draft  
...
- **SC-001**: Il 100% delle operazioni di noleggio su auto disponibili deve andare a buon fine.
- **SC-002**: Il 100% dei tentativi di noleggio su auto già noleggiate deve essere bloccato con un messaggio di errore chiaro.
- **SC-003**: Il conteggio delle auto disponibili deve essere accurato e aggiornato istantaneamente dopo ogni operazione.