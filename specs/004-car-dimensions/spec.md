...
**Feature Branch**: `004-car-dimensions`  
**Created**: 2026-01-13  
**Status**: Draft  
...
- **SC-003**: La logica di assegnazione deve poter gestire correttamente richieste per mezzi con capacità fino a 50 posti (es. autobus) senza degradazione delle performance percepita dall'utente.