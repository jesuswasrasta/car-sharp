...
public interface IAuto
{
    ...
    string Targa { get; }
    int Capacita { get; }
    decimal CostoGiornaliero { get; }
}

/// <summary>
/// Rappresenta un'auto pronta per essere noleggiata.
/// </summary>
public record AutoDisponibile(Guid Id, string Targa, int Capacita, decimal CostoGiornaliero) : IAuto;

/// <summary>
/// Rappresenta un'auto attualmente in uso da un cliente.
/// </summary>
public record AutoNoleggiata(Guid Id, string Targa, int Capacita, decimal CostoGiornaliero) : IAuto;
